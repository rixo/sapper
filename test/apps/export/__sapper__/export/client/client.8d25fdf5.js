...
const components = [
	{
		js: () => import('./index.707acf72.js'),
		css: []
	},
	{
		js: () => import('./index.4867950d.js'),
		css: []
	},
	{
		js: () => import('./[slug].95445313.js'),
		css: []
	},
	{
		js: () => import('./index.8b25b265.js'),
		css: []
	},
	{
		js: () => import('./index.b229b651.js'),
		css: []
	},
	{
		js: () => import('./[b].html.4be453a3.js'),
		css: []
	},
	{
		js: () => import('./[b].804df3ae.js'),
		css: []
	}
];
...
const routes = (d => [
...

	{
		...
		parts: [
			null,
			null,
			{ i: 5, params: match => ({ a: d(match[1]), b: d(match[2]) }) }
		]
	},

	{
		...
		parts: [
			null,
			null,
			{ i: 6, params: match => ({ a: d(match[1]), b: d(match[2]) }) }
		]
	}
])(decodeURIComponent);
