...
const css = {
	...
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<h1>Great success!</h1>\\n\\n<a href=\\\"foo\\\">foo</a>\\n<a href=\\\"bar\\\">bar</a>\\n\\n<style>\\n\\th1 {\\n\\t\\tcolor: red;\\n\\t}\\n</style>\"],\"names\":[],\"mappings\":\"AAMC,EAAE,cAAC,CAAC,AACH,KAAK,CAAE,GAAG,AACX,CAAC\"}"
};

const Index = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css);

	return `<h1 class="svelte-bt9zrl">Great success!</h1>
...
const Bar = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { Title } = $$props;

	__chunk_1.onMount(() => {
		new Promise(function (resolve) { resolve(require('./Title-0a8593d2.js')); }).then(mod => {
			Title = mod.default;
		});
	});
	...
	return `${__chunk_1.validate_component(((Title) || __chunk_1.missing_component), 'svelte:component').$$render($$result, {}, {}, {})}`;
});

/* test/apps/css/src/routes/foo.svelte generated by Svelte v3.6.9 */

const css$1 = {
	code: "h1.svelte-1x1ajbk{color:blue}",
	map: "{\"version\":3,\"file\":\"foo.svelte\",\"sources\":[\"foo.svelte\"],\"sourcesContent\":[\"<h1>Foo</h1>\\n\\n<style>\\n\\th1 {\\n\\t\\tcolor: blue;\\n\\t}\\n</style>\"],\"names\":[],\"mappings\":\"AAGC,EAAE,eAAC,CAAC,AACH,KAAK,CAAE,IAAI,AACZ,CAAC\"}"
};

const Foo = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$1);

	return `<h1 class="svelte-1x1ajbk">Foo</h1>`;
});

/* test/apps/css/src/node_modules/@sapper/internal/layout.svelte generated by Svelte v3.6.9 */

const Layout = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${$$slots.default ? $$slots.default() : ``}`;
});

/* test/apps/css/src/routes/_error.svelte generated by Svelte v3.6.9 */
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/bar\/?$/,
			parts: [
				{ name: "bar", file: "bar.svelte", component: Bar }
			]
		},

		{
			...
			pattern: /^\/foo\/?$/,
			parts: [
				{ name: "foo", file: "foo.svelte", component: Foo }
			]
		}
	],
...
/* test/apps/css/src/node_modules/@sapper/internal/App.svelte generated by Svelte v3.6.9 */
