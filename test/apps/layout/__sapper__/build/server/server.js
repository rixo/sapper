...
var index = require('./index-e7c0b65f.js');
var __chunk_2 = require('./chunk-81666c81.js');
var _layout = require('./_layout-d4f5af72.js');
var _z_ = require('./[z]-d7e195c6.js');
...
const manifest = {
	...
	pages: [
...

		{
			...
			parts: [
				null,
				{ name: "$x$93_$91y__layout", file: "[x]/[y]/_layout.svelte", component: _layout.default, preload: _layout.preload, params: match => ({ x: d(match[1]), y: d(match[2]) }) },
				{ name: "$x$93_$91y$93_$91z", file: "[x]/[y]/[z].svelte", component: _z_.default, preload: _z_.preload, params: match => ({ x: d(match[1]), y: d(match[2]), z: d(match[3]) }) }
			]
		}
	],
