...
class App extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$2, safe_not_equal, ["stores", "error", "status", "segments", "level0", "level1", "level2", "notify"]);
	}
}
...
const components = [
	{
		js: () => import('./index.88f3fa4c.js'),
		css: []
	},
	{
		js: () => import('./_layout.45ea6193.js'),
		css: []
	},
	{
		js: () => import('./[z].14487a39.js'),
		css: []
	}
];
