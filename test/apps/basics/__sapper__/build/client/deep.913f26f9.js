...
function create_fragment(ctx) {
	var h1, t0_value = ctx.$page.params.rest.join(','), t0, t1, h2, t2_value = ctx.rest.join(','), t2, t3, a0, t4, t5, a1, t6;
	...
	return {
		...
		l(nodes) {
			...
			t6 = claim_text(a1_nodes, "back");
			a1_nodes.forEach(detach);
			this.h();
		},

		h() {
			attr(a0, "href", "xyz/abc/qwe/deep.json");
...
class Deep extends SvelteComponent {
	constructor(options) {
		super();
