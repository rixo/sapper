...
const components = [
	{
		js: () => import('./index.cc390693.js'),
		css: []
	},
	{
		js: () => import('./contact.be79d86a.js'),
		css: []
	},
	{
		js: () => import('./about.41a70d5e.js'),
		css: []
	},
	{
		js: () => import('./index.9ddd5789.js'),
		css: []
	},
	{
		js: () => import('./[slug].3fa387c2.js'),
		css: []
	},
	{
		js: () => import('./index.6e0594b3.js'),
		css: []
	},
	{
		js: () => import('./index.58934974.js'),
		css: []
	},
	{
		js: () => import('./[b].0b928bfb.js'),
		css: []
	}
];
...
const routes = (d => [
...

	{
		...
		parts: [
			null,
			null,
			{ i: 7, params: match => ({ a: d(match[1]), b: d(match[2]) }) }
		]
	}
])(decodeURIComponent);
