...
const components = [
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-5ab053db.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:index.html__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./fünke-ffc3d241.js')); }),
...
const Slug = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<h1>${__chunk_1.escape(slug)} ${__chunk_1.escape(JSON.stringify($page.query))}</h1>`;
});
