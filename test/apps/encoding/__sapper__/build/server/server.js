...
var index = require('./index-5ab053db.js');
var f_nke = require('./fünke-ffc3d241.js');
var __chunk_2 = require('./chunk-523ec1a4.js');
	...
	pages: [
		{
			...
			pattern: /^\/$/,
			parts: [
				{ name: "index", file: "index.html", component: index.default }
			]
		},

		{
			...
			pattern: /^\/f%C3%BCnke\/?$/,
			parts: [
				{ name: "f$252nke", file: "fünke.html", component: f_nke.default, preload: f_nke.preload }
			]
		},

		{
			...
			parts: [
				null,
				null,
				{ name: "echo_page_$slug", file: "echo/page/[slug].html", component: __chunk_2.component_2, preload: __chunk_2.preload, params: match => ({ slug: d(match[1]) }) }
			]
		}
	],
