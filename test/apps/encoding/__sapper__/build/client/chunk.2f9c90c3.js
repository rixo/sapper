...
/* test/apps/encoding/src/node_modules/@sapper/internal/layout.svelte generated by Svelte v3.6.9 */
...
/* test/apps/encoding/src/routes/_error.html generated by Svelte v3.6.9 */
...
/* test/apps/encoding/src/node_modules/@sapper/internal/App.svelte generated by Svelte v3.6.9 */
...
const ignore = [/^\/f%C3%BCnke\.json$/, /^\/echo\/server-route\/([^\/]+?)\/?$/];

const components = [
	{
		js: () => import('./index.49fd83ca.js'),
		css: []
	},
	{
		js: () => import('./fünke.fefea035.js'),
		css: []
	},
	{
		js: () => import('./[slug].75e7dd0a.js'),
		css: []
	}
];
