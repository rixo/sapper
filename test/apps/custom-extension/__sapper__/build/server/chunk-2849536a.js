...
const components = [
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-e4854177.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:index.jesuslivesineveryone__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./unsafe-replacement-90cf7e71.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:unsafe-replacement.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./const-6997a28c.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:const.whokilledthemuffinman__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./a-7336bf9d.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:a.svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return _slug_; }),
		css: "__SAPPER_CSS_PLACEHOLDER:[slug].mdx__"
	}
];
...
const Slug = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<h1>${__chunk_1.escape($page.params.slug.toUpperCase())}</h1>`;
});
