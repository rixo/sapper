...
var cookie$1 = _interopDefault(require('cookie'));
...
function get(req, res) {
	if (req.headers.cookie) {
		const cookies = cookie$1.parse(req.headers.cookie);
...
/* test/apps/credentials/src/routes/index.html generated by Svelte v3.6.9 */
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/credentials\/?$/,
			parts: [
				{ name: "credentials", file: "credentials/index.html", component: Index$1, preload: preload }
			]
		}
	],
