...
const components = [
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-866fed32.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./preloaded-299835f1.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:preloaded.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./session-25b1b6a4.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:session.svelte__"
	}
];
