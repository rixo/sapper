...
var index = require('./index-866fed32.js');
var __chunk_2 = require('./chunk-82f3bf38.js');
var preloaded = require('./preloaded-299835f1.js');
var session = require('./session-25b1b6a4.js');
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/preloaded\/?$/,
			parts: [
				{ name: "preloaded", file: "preloaded.svelte", component: preloaded.default, preload: preloaded.preload }
			]
		},

		{
			...
			pattern: /^\/session\/?$/,
			parts: [
				{ name: "session", file: "session.svelte", component: session.default }
			]
		}
	],
