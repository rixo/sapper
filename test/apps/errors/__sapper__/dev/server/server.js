...
const Enhance_your_calm = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return ``;
});
...
const Preload_reject = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<h1>Test has failed</h1>`;
});

/* src/routes/no-error.svelte generated by Svelte v3.2.2 */

const No_error = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { error } = $$props;

	if ($$props.error === void 0 && $$bindings.error && error !== void 0) $$bindings.error(error);

	return `<h1>${escape(error ? error.message : 'No error here')}</h1>
...
const Throw = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return ``;
});
...
const manifest = {
	...
	pages: [
...

		{
			...
			parts: [
				{ name: "enhance$45your$45calm", file: "enhance-your-calm.svelte", component: Enhance_your_calm, preload: preload }
			]
		},

		{
			...
			parts: [
				{ name: "preload$45reject", file: "preload-reject.svelte", component: Preload_reject, preload: preload$1 }
			]
		},

		{
			...
			pattern: /^\/no-error\/?$/,
			parts: [
				{ name: "no$45error", file: "no-error.svelte", component: No_error }
			]
		},

		{
			...
			pattern: /^\/throw\/?$/,
			parts: [
				{ name: "throw_", file: "throw.svelte", component: Throw, preload: preload$2 }
			]
		},

		{
			...
			parts: [
				null,
				{ name: "blog_$slug", file: "blog/[slug].html", component: Slug, preload: preload$3, params: match => ({ slug: d(match[1]) }) }
			]
		}
	],
