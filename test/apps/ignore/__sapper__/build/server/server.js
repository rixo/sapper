...
/* test/apps/ignore/src/routes/a.svelte generated by Svelte v3.6.9 */
...
/* test/apps/ignore/src/routes/[slug].svelte generated by Svelte v3.6.9 */

const Slug = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<h1>${escape(params.slug.toUpperCase())}</h1>`;
});
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/a\/?$/,
			parts: [
				{ name: "a", file: "a.svelte", component: A }
			]
		},

		{
			...
			pattern: /^\/b\/?$/,
			parts: [
				{ name: "b", file: "b/index.html", component: Index$1, preload: preload }
			]
		},

		{
			...
			pattern: /^\/([^\/]+?)\/?$/,
			parts: [
				{ name: "$slug", file: "[slug].svelte", component: Slug, params: match => ({ slug: d(match[1]) }) }
			]
		}
	],
...
const app = polka().use(middleware({
	ignore: [
		/foobar/i,
		'/buzz',
		'fizz',
