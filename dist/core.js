...
class RollupCompiler {
	...
	constructor(config, use_nollup = false) {
	...
	static async load_config(cwd, use_nollup = false) {
		if (!rollup) rollup = requireRelative_1('rollup', cwd);
		if (use_nollup && !nollup) nollup = requireRelative_1('nollup/lib/dev-server', cwd);
